...
<template>
    <div class="schedule-weekly">
      ...
      <div class="weekday-selector mb-4">
        <h4 class="subtitle is-5 mb-2">Select Days</h4>
        <div class="field is-grouped is-grouped-multiline">
          <div 
            v-for="day in weekDays" 
            :key="day.value"
            class="control weekday-item"
          >
            <label class="checkbox">
              <input
                type="checkbox"
                :value="day.value"
                v-model="scheduleData.selectedDays"
      ...
      <div class="times-container">
        <h4 class="subtitle is-5 mb-2">Weekly Times</h4>
        <div 
    ...
    methods: {
      ...
      updateSchedule() {
        ...
        this.$emit('input', {
          ...
          schedule: {
            ...
            days: this.scheduleData.selectedDays,
            times
          }
        })
      },
      ...
      initializeSchedule() {
        if (this.value.schedule) {
          ...
          this.scheduleData.selectedDays = this.value.schedule.days || []
